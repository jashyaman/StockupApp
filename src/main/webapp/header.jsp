<%
	...
	if(cookies == null)
	{
		...
		Home_label = "<a href=\"/stockapp/index.jsp\">Home</a>";
	...
	else
	{
		...
		else
		{
			...
			if(Admin)
				Home_label = "<a href=\"/stockapp/AdminDashboard\">Admin Home</a>";
			else
				Home_label = "<a href=\"/stockapp/BrokerDashboard\">Broker Home</a>";
		}
	}
  %>
...
function home(){
   window.location = "http://localhost:8080/stockapp/index.jsp";
}
function logout(){
	window.location = "http://localhost:8080/stockapp/LogoutServlet";
}
function login(){
	window.location = "http://localhost:8080/stockapp/LoginServlet";   //// <<<<<<<<
}
</script>
