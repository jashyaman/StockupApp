...
<form id="#formlogin" name="Login" action="/stockapp/LoginServlet" method="POST" onsubmit="return validateLoginForm()">
<br>
Username:
...
<br>
<a href="/stockapp/Forgotpassword.html">Forgot password</a>
<br>
<br>
