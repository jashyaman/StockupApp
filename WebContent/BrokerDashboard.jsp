...
<p>${companynames } Require your acknowledgement to be the authorized personnel for the company account. Kindly <a href="/Stock/AckServlet?companyname=${companynames}&username=${requestScope.username}">acknowledge</a></p>
</c:forEach>
 </c:otherwise>
</c:choose>
</div>
